...
function Data() {
	return (
		<svg width="1em" height="1em" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M44 29C44 32.3137 35.0457 35 24 35C12.9543 35 4 32.3137 4 29" stroke="#212121" stroke-width="3"
			      stroke-linecap="square" stroke-linejoin="round"/>
			<path d="M44 20C44 23.3137 35.0457 26 24 26C12.9543 26 4 23.3137 4 20" stroke="#212121" stroke-width="3"
			      stroke-linecap="square" stroke-linejoin="round"/>
			<ellipse cx="24" cy="10" rx="20" ry="6" fill="#2F88FF" stroke="#212121" stroke-width="3"
			         stroke-linecap="square" stroke-linejoin="round"/>
		</svg>
	)
}
