...
function CloudStorage() {
	return (
		<svg width="1em" height="1em" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M44 29H4V42H44V29Z" fill="#2F88FF" stroke="#212121" strokeWidth="3" strokeLinejoin="round"/>
			<path
				...
				fill="#FFF"/>
			<path d="M4 28.9998L9.03837 4.99902H39.0205L44 28.9998" stroke="#212121" strokeWidth="3"
			...
			<path d="M29.0069 16.0261C29.0069 13.0423 27.0231 11 23.9998 11C20.9766 11 19.0059 12.9927 19.0059 16.0261"
			      stroke="#212121" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round"/>
			<path d="M20 23H28" stroke="#212121" strokeWidth="3"/>
		</svg>
	)
}
