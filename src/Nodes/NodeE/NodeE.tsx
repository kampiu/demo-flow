...
interface NodeEProps extends NodeProps {
	isMenu?: boolean
}

export interface NodeEInstance {

}

const NodeE = forwardRef<NodeEInstance, NodeEProps>((props, ref) => {
	...
	useImperativeHandle(ref, (): NodeEInstance => {
		return {}
	})
