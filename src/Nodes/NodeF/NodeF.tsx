...
interface NodeFProps extends NodeProps {
	isMenu?: boolean
}

export interface NodeFInstance {

}

const NodeF = forwardRef<NodeFInstance, NodeFProps>((props, ref) => {
	...
	useImperativeHandle(ref, (): NodeFInstance => {
		return {}
	})
